...
DEFAULT_QUARANTINE_ENABLED = os.getenv("ARGUS_QUARANTINE_ENABLED", "1") != "0"
DEFAULT_QUARANTINE_BLOCK_COUNT = int(os.getenv("ARGUS_QUARANTINE_BLOCK_COUNT", "8"))
DEFAULT_QUARANTINE_RISK_THRESHOLD = float(os.getenv("ARGUS_QUARANTINE_RISK_THRESHOLD", "0.85"))
DEFAULT_QUARANTINE_LONG_WINDOW_SECONDS = int(os.getenv("ARGUS_QUARANTINE_LONG_WINDOW_SECONDS", "3600"))
...
class QuarantinePolicy:
    ...
    def __init__(
        ...
        *,
        ...
        self.long_window_block_count = long_window_block_count if long_window_block_count is not None else int(os.getenv("ARGUS_QUARANTINE_LONG_WINDOW_COUNT", "15"))
