...
from argus.modules.media_input import extract_attachments  # noqa: E402
from argus.modules.media_input.config import (  # noqa: E402
    DEFAULT_CONFIG,
    load_media_config,
)
from argus.modules.media_input.mime import (  # noqa: E402
    is_supported,
    normalize_type,
    sniff_mime,
)
from argus.modules.media_input.download import fetch_remote  # noqa: E402
...
def test_remote_temp_file_is_removed_after_extraction(
    ...
    import argus.modules.media_input as media_input
