"""Argus adapter for the integrated IO Guard implementation."""
...
from argus.modules.media_input import extract_attachments
from argus.modules.media_input.config import load_media_config
...
class IoGuardAdapter(BaseAdapter):
    """Translate Argus requests to the original IO Guard service API.
    ...
    Argus API remains cheap and a missing optional model is reported as a
    ...
    def _get_delegate(self) -> Any:
        ...
        from io_guard.adapters.argus_adapter import (
