"""检索安全模块 Adapter：对接 Clawguard 统一接口。
...
from clawguard.modules.retrieval_guard.original.a_url import URLWhitelist
from clawguard.modules.retrieval_guard.original.c_prompt import PromptWrapper
        ...
        try:
            with self._load_lock:
                if self._injection_guard is None:
                    from clawguard.modules.retrieval_guard.original.b_injection import InjectionGuard
