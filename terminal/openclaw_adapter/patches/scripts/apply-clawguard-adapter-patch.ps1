# Clawguard Adapter compatibility patch for OpenClaw 2026.6.11.
...
if ($source.Contains($patchedMarker)) {
  Write-Output "Clawguard prompt rewrite patch is already applied: $target"
  exit 0
}
